...
class CreateApplicationsTable extends Migration
{
    ...
    public function up()
    {
      Schema::create('applications', function (Blueprint $table) {
        ...
        $table->string('file_portrait', 255)->nullable();
        $table->string('file_annual_report', 255)->nullable();
        $table->string('file_annual_financial_report', 255)->nullable();
        $table->string('file_budget', 255)->nullable();
        $table->string('file_bylaws', 255)->nullable();
        $table->string('file_project_description', 255)->nullable();
        $table->string('file_project_estimated_costs', 255)->nullable();
